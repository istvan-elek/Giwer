...
namespace Giwer
{
     ...
     * 
     * parse header: it reads the bil header line by line (getParams(string line))
     * getParams: get bil parameters from the header (parse header) line by line
     * get image data from the given band: getOneBandBytes(int whichBand)
     * Convert of the image content from a given band into a bitmap: convertOneBandBytestoBitmap(byte[] byIn)
     * Convert the given bitmap to a byte array: BitmapToByteArray(Bitmap img)
     * convert byte array to bitmap: ByteArrayToBitmap(byte[] byteIn, int imwidth, int imheight)
     */
    public class ESRI_BIL
    {
        ...
        // parse header: it parses the bil header parameters
        ...
        // getParams: get bil parameters from the header line by line
...
// global procedures and functions ---------------------------------------------------------
            ...
            // get image data from the given band 
        ...
        //Convert the given bitmap to a byte array
